...
- Fit tolerance (too tight scratches plastic; too loose twists)
- Closure or retention if not a full wrap
- Optional D-ring / split ring / hook without blocking wireless charging

**Room to fill later**

- AirPods generation and case dimensions
- Pattern sketch or vendor pattern reference
- Finish photos on the device
